      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <?php } ?>
               <?php echo form_open_multipart('category/addCategory',array('role'=>'form')); ?>
               <input type="hidden" name="parent_cat_id" value=0>
               <div class="box-body">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="">Category Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control category_name" name="category_name" placeholder="Category Name" autocomplete="off" required="">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-12"> 
                     <div class="form-group">
                        <label for="">Url Slag <span class="text-danger">*</span></label>
                        <input type="text" name="url_slug" class="form-control url_slug" value="" required=""placeholder="Url Slag">
                     </div>
                  </div>
                  <input type="hidden" name="url_host" value="<?php echo SERVERNAME.'/auto_gorilla/'?>">
                  <input type="hidden" name="cat_level" value="1">
                  <div class="col-md-12"> 
                     <div class="form-group">
                  ...
                  <div class="col-md-12"> 
                     <div class="form-group">
                        ...
                        <textarea name="footer_content" class="form-control category_content"  placeholder="Footer Content" id="footer_content"></textarea>
                     </div>
                  </div>
                  ...
                  <div class="box-footer">
                     <input type="submit" name="submit" class="btn btn-primary ValidateCharacterLength" >
                  </div>
                  <?php echo form_close(); ?>
               </div>
            </div>
