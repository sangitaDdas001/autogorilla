<?php 
   $seo_meta_info       = seo_meta_information('parent category',$fetch_data['url_slug']); 
   $seo_multi_meta_info = seo_multi_meta_information('parent category',$fetch_data['url_slug']); 
   $seo_social_og_info  = seo_social_ogInfo('parent category',$fetch_data['url_slug']); 
?>
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <?php } ?>
               <?php echo form_open_multipart('category/updateCategory',array('role'=>'form')); ?>
               <input type="hidden" name="cat_id" id="cat_id" value="<?php echo $cat_id; ?>">
               <div class="box-body">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="books category">Category Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control category_name" name="category_name" placeholder="Category Name" autocomplete="off" value="<?php echo $fetch_data['category_name']; ?>">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="books category">Url Slug<span class="text-danger">*</span></label>
                        <input type="text" class="form-control url_slug" name="url_slug" placeholder="Url Slug" autocomplete="off" value="<?php echo $fetch_data['url_slug']; ?>" readonly>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <img src="<?php echo VIEW_IMAGE_URL.'categories/'.$fetch_data['category_image']; ?>" class='img-thumbnail img-rounded' width=180 height=200 alt="categories image">
                     </div>
                  </div>
               ...
               <div class="box-footer">
                  ...
                  <button type="button" name="submit" class="btn btn-primary" onclick="window.location.href='<?php echo base_url('category/viewCategory'); ?>'">Back</button>
               </div>
