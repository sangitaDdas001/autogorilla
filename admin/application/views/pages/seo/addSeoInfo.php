      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <?php } ?>
               <?php echo form_open_multipart('seo/add_seo',array('role'=>'form')); ?>
               <div class="box-body">
                   <div class="col-md-12">
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="page_url" placeholder="Page Url" autocomplete="off" required="required" >
                        </div>
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="meta_title" placeholder="Meta Title" autocomplete="off" required="" >
                        </div>
                     </div>
                     <div class="col-md-6">
                       <div class="form-group">
                           <label for="">Canonical Url<span class="text-danger">*</span></label>
                           <input type="text" class="form-control" name="canonical_url" placeholder="Canonical Url" autocomplete="off" required="">
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group">
                           <label for="">Meta Description<span class="text-danger">*</span></label>
                           <textarea name="meta_description" class="form-control" placeholder="Meta Description" id="meta_description" required></textarea>
                        </div>
                     </div>
                  </div>
