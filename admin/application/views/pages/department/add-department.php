      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <?php echo form_open_multipart('UserManagement/addDepartment',array('role'=>'form')); ?>
               <div class="box-body">
                  <div class="col-md-12">
                     <div class="form-group">
                        <label for="">Department Name<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="department_name" placeholder="Department Name" autocomplete="off">
                     </div>
                  </div>
