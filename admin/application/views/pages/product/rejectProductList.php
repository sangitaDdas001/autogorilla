<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Reject Product Information
      </h1>
      
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="<?php echo base_url('product/reject_list'); ?>">Reject Product List</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Reject Product List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?php } ?>
              ...
              <table id="reject_product_details" class="table table-bordered table-hover">
                <thead>
                  <tr>
