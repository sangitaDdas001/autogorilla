<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         <li><button type="button" name="submit" class="btn btn-primary" onclick="window.location.href='<?php echo base_url('product/all_product_list'); ?>'">Back</button></center></li>
      </ol>
   </section>
   <!-- Main content -->
                  ...
                  <div class="card">
                     <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                           ...
                           <h4 class="mb-0"><?php echo $success_csvdata + $failed_csvdata; ?></h4>
                        </div>
                     </div>
                  ...
                  <div class="card">
                     <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                           ...
                           <form action="<?php echo base_url('product/successCsvDownload'); ?>" method="post">
                              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                              <input type="hidden" name="uniq_code" value="<?php echo $uniq_code; ?>">
                              <button type="submit" name="Download Product Csv" class="btn btn-success" id="success_product_csv">Success Product Csv <i class="fa fa-arrow-down" aria-hidden="true"></i></button>
                           </form>
                        </div>
                     </div>
                     <!-- <hr class="dark horizontal my-0">
                  ...
                  <div class="card">
                     <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                           ...
                           <form action="<?php echo base_url('product/failedCsvDownload'); ?>" method="post">
                              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                              <input type="hidden" name="uniq_code" value="<?php echo $uniq_code; ?>">
                              <button type="submit" name="Download Product Csv" class="btn btn-danger" id="failed_product_csv">Failed Product Csv <i class="fa fa-arrow-down" aria-hidden="true"></i></button>
                           </form>
                        </div>
                     </div>
                     <!-- <hr class="dark horizontal my-0">
                ...
                <div class="card failed-details-block">
                 ...
                 <div class="card-body px-0 pb-2">
                    <div class="table-responsive" style="margin-right: 2%;margin-left: 2%;">
                       <table id="product_rejected_list" class="table table-bordered table-hover align-items-center mb-0 table-padding-15">
                           <thead>
                           <tr>
