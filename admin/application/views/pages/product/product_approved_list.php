<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('product'); ?>">Supplier List</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Approved Product List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div style="margin-bottom: 4%;">
                <form action ="<?php echo base_url('product/export_approved_productData'); ?>" method="post">
                  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                  <input type="submit" class="btn btn-warning" value="Export Approved Product Data" style="margin-right: 1%;">
                </form>
              </div>
              <div class="row">
                <input type="hidden" name="csrf" value="<?php echo $this->security->get_csrf_token_name(); ?>">
                  <div class="form-group col-md-4"> 
                    <label for="">Search Minimum Product Score</label>
                      <input type="text" id="min_ps" name="min_ps" class="form-control"  placeholder="Search.." data-type="search">
                  </div> 
                  <div class="form-group col-md-4"> 
                    <label for="">Search Maximum Product Score</label>
                      <input type="text" id="max_ps" name="max_ps" class="form-control"  placeholder="Search.." data-type="search">
                  </div> 
                  <div class="form-group col-md-4" > 
                    <button type="button" name="submit" id="clear-filter" class="btn btn-primary mt-25px">Reset</button>
                  </div> 
              </div>
              <table id="approved_product_details" class="table table-bordered table-hover">
                <thead>
                  <tr>
