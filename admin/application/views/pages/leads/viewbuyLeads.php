        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Buy Leads Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div style="margin-bottom: 4%;">
              <form action="<?php echo base_url('leads/allBuyLeadCsvExport'); ?>" method="post">
            ...
            <div class="row">
              ...
              <table id="buy_leads_details" class="table table-bordered table-hover">
                <thead>
                  <tr>
