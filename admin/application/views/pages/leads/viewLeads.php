        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Leads Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div style="margin-bottom: 4%;">
              ...
              <form action="<?php echo base_url('leads/allLeadCsvExport'); ?>" method="post">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            ...
            <div class="row">
              ...
              <table id="leads_details" class="table table-bordered table-hover">
                <thead>
                  <tr>
