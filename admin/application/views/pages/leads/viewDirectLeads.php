        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Direct Leads Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div style="margin-bottom: 4%;">
              <form action="<?php echo base_url('leads/directAllLeadCsvExport'); ?>" method="post">
            ...
            <div class="row">
              ...
              <table id="all_direct_leads_details" class="table table-bordered table-hover">
                <thead>
                  <tr>
