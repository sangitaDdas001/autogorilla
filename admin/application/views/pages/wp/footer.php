                    ...
                    <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                              ...
                              <div class="mt-3 footer_contact">
                                    <?php dynamic_sidebar('sidebar-2'); ?>
                                    <?php dynamic_sidebar('sidebar-3'); ?>
                              </div>
                              <div class="mt-3 footer_social">
                          ...
                          <?php  if ( has_nav_menu( 'footer' ) ) {
                           ?>
                            <div class="col-md-6 text-left text-xs">
                              <p class="mb-0">
                                <?php $blogus_footer_copyright = get_theme_mod( 'blogus_footer_copyright','Copyright © 2024 AutoGorilla Pvt. Ltd. All rights reserved.' );
