<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Gold Seller Information
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Gold Seller Information</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Gold Seller Information</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?php } ?>
              ...
              <table id="gold_seller" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                      <th>Sl No.</th>
                      <th>Company Name</th>
                ...
                <tbody>
                  <?php foreach ($gold_member_list as $key => $value): ?>
                    <tr>
