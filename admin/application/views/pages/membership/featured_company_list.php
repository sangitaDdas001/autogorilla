<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Silver Seller Information
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Silver Seller Information</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Silver Seller Information</h3>
            </div>
            ...
            <?php } ?>
              ...
              <table id="silver_seller" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                      <th>Sl No.</th>
                      <th>Company Name</th>
                ...
                <tbody>
                  <?php foreach ($featured_member_list as $key => $value): ?>
                    <tr>
