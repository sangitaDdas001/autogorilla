      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <?php } ?>
               <?php echo form_open_multipart('service/updateServicePlan',array('role'=>'form')); ?>
               <input type="hidden" name="id" value="<?php echo $id; ?>">
               <div class="box-body">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="">Service Name</label>
                        <input type="text" class="form-control" name="service_plan" placeholder="Service Plan Name" autocomplete="off" value="<?php echo $fetch_data['service_plan']; ?>">
                     </div>
                  </div>  
                  <div class="col-md-3">
                     <div class="form-group">
                  ...
                  <div class="col-md-3">
                     <div class="form-group"> 
                        ...
                        <img src="<?php echo VIEW_IMAGE_URL .'serviceLogo/'.$fetch_data['logo']; ?>" alt="serviceLogo">
                     </div>
                  </div>
               <!-- /.box-body -->
